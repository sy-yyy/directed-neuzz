...
def process_data():
    ...
    dominate = [32486,36757,10769,37008]
    dominate.extend(label)
...
def gen_mutate2(model, edge_num, sign):
    ...
    interested_indice = np.random.choice(MAX_BITMAP_SIZE, 100)
    predominate = list(range(MAX_BITMAP_SIZE-5,MAX_BITMAP_SIZE-1))
    predominate.extend(interested_indice)
