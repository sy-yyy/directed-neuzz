      ...
      for (auto &BB : F) {
        ...
        for (auto &I : BB) {
	      ...
	      ss << I;
            ...
            bb_name = filename + ":" + std::to_string(line) + ":" + std::to_string(col) + ss.str();
          }
    ...
    for (auto &F : M) {
      ...
      for (auto &BB : F) {
        ...
        if (distance >= 0) {
          ...
          std::cout << "  bb_name:  " << dominate_name << "  cur_Loc:  " << cur_loc <<"\n";
